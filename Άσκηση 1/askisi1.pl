...
family(person(evangelos, manolatos, date(31, march, 1942), works(archirodon, 5000)), person(theodora, manolatou, date(13, june, 1939), works(cleaner, 3000)),    []).
...
/* ΑΥΤΟ ΔΟΥΛΕΥΕΙ!!! */
%exists(person(FIRSTNAME, LASTNAME, date(DAY, MONTH, YEAR), works(PLACE, SALARY))), dateofbirth(MONTH, YEAR), salary(PLACE, SALARY), X < 1950, Y < 8000.