...
family(person(georgios,     dertayan,       date(2, november, 1931), works(retired), 3900)),    person(vasiliki,  dertayan,      date(20, december, 1935), works(retired, 900)),  [person(pat, fox, date(5, may, 1973), unemployed),                person(jim, fox, date(5, may, 1973), unemployed)]).
