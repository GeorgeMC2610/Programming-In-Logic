...
family(person(marinos,      papadakis,      date(30, june, 1932),    works(retired, 2400)),    person(amalia, papadaki, date(26, april, 1934), unemployed),                [person(emmanouil, papadakis, date(11, september, 1968), works(attikiodos, 3000)), person(dimitrios, papadakis, date(29, september, 1973), works(lg, 1200)), person(elena, papadaki, date(25, february, 1976), works(samsung, 1200))]).
family(person(georgios,     dertayan,       date(2, november, 1931), works(retired), 3900)),   person(ann, fox, date(9, may, 1951), unemployed),                           [person(pat, fox, date(5, may, 1973), unemployed),                person(jim, fox, date(5, may, 1973), unemployed)]).
family(person(ilias,        mitaj,          date(18, august, 1994),  works(olympiakos, 9000)), person(ann, fox, date(9, may, 1951), unemployed),                           [person(pat, fox, date(5, may, 1973), unemployed),                person(jim, fox, date(5, may, 1973), unemployed)]).
family(person(konstantinos, mparmparoussis, date(22, march, 1989),   works(id, 4000)),         person(ann, fox, date(9, may, 1951), unemployed),                           [person(pat, fox, date(5, may, 1973), unemployed),                person(jim, fox, date(5, may, 1973), unemployed)]).
family(person(eleftherios,  manousopoulos,  date(17, april, 1930),   works(activision, 5000)), person(ann, fox, date(9, may, 1951), unemployed),                           [person(pat, fox, date(5, may, 1973), unemployed),                person(jim, fox, date(5, may, 1973), unemployed)]).
