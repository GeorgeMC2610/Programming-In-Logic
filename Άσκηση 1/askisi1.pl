...
family(person(georgios,     dertayan,       date(2, november, 1931), works(retired), 3900)),    person(vasiliki,  dertayan,      date(20, december, 1935), works(retired, 900)),  [person(danai,     dertayan,      date(5, may, 1973), unemployed),                person(jim, fox, date(5, may, 1973), unemployed)]).
...
family(person(eleftherios,  manousopoulos,  date(17, april, 1930),   works(activision, 5000)),  person(melina,    manousopoulou, date(31, december, 1931), unemployed),           [person(pavlos,    manousopoulos, date(5, may, 1973), unemployed),                person(jim, fox, date(5, may, 1973), unemployed)]).
