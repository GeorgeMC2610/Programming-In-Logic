...
/* αλλιώς, παίρνουμε αναδρομικά τον κώδικα αυτόν και βλέπουμε αν υπάρχει combo με ΚΑΠΟΙΟ c. Αν υπάρχει το βάζουμε στη λίστα και συνεχίζουμε την εύρεση του αγνώστου. Αυτό ακριβώς, τίποτε άλλο. */
find_path(A, A, T, T).
find_path(A, B, T, T2) :- 
